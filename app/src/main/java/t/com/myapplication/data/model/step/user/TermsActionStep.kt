 ...
 */
class TermsActionStep(message: Message, errorMessage: ErrorMessage, btnPositiveText: String, btnNegativeText: String) : BaseSelectionActionStep(message, errorMessage, btnPositiveText, btnNegativeText)
